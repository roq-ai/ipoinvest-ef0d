...
function StartupListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<StartupInterface[]>(
    ...
    () =>
      getStartups({
        relations: ['user', 'game_player.count', 'gmp.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('gmp', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>gmp</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
